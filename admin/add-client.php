...
<li class="nav-item">
          ...
          <div class="page-header">
            <div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="card-body cd3">
                          <h4 class="card-title">Shto një klient</h4>
                          <p class="card-description">Plotëso të gjitha të dhënat</p>
                          <form method="POST" id="UserFrom" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              <label for="exampleInputEmail1">ID e kompjuterit</label>
                              <input type="text" name="computer_id" class="form-control" id="exampleInputEmail1" placeholder="Id e kompjuterit" />
                              <span id="CompIderror" style="color: red; font-size:0.8em"></span>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputEmail1">Adresa</label>
                              <input type="text" name="address" class="form-control" id="exampleInputEmail1" placeholder="Adresa" />
                              <span id="CompIderror" style="color: red; font-size:0.8em"></span>
                            </div>
                            <button type="submit" class="btn btn-primary mr-2" style="font-size: 1.03em;"> Ruaj </button>
                          </form>
                        </div>
              </div>
            </div>
  ...
  <script>
       document.getElementById("MM3").style.color = "white";
      document.getElementById("MM4").style.color = "white";
      </script>
</body>
